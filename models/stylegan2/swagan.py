...
from models.stylegan2.model import ModulatedConv2d, StyledConv, ConstantInput, PixelNorm, Upsample, Downsample, Blur, EqualLinear, ConvLayer
...
class Generator(nn.Module):
    ...
    def forward(
        ...
        for conv1, conv2, noise1, noise2, to_rgb in zip(self.convs[::2], self.convs[1::2], noise[1::2], noise[2::2], self.to_rgbs):
            ...
            if i==7 and conditions is not None:
                #11 for 256, 9 for 128， 7 for 64
                out  =  out  * (1 + conditions[0]) + conditions[1]
